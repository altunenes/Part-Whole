...
img = cv2.imread("otherface.jpg")
img_gray = cv2.cvtColor(img, cv2.COLOR_BGR2GRAY)
img_gaus=cv2.GaussianBlur(img_gray,(7,7),60)
mask = np.zeros_like(img_gray)
img2 = cv2.imread("testface.jpg")
img2_gray = cv2.cvtColor(img2, cv2.COLOR_BGR2GRAY)
img_gaus2=cv2.GaussianBlur(img2_gray,(7,7),60)
...
for face in faces:
    ...
    #
    #
    # for n in range(18,26):   #eyesbrowns
    #      x = landmarks.part(n).x
    #      y = landmarks.part(n).y
    #      landmarks_points.append((x, y))
    #

    # for n in range(34,42):    #left eye
    #     x = landmarks.part(n).x
    #     y = landmarks.part(n).y
    #     landmarks_points.append((x, y))
    # for n in range(43,48):    #right eye
    #      x = landmarks.part(n).x
    #      y = landmarks.part(n).y
    #      landmarks_points.append((x, y))
    # for n in range(47,67):   #mouth
    #       x = landmarks.part(n).x
    #       y = landmarks.part(n).y
    #       landmarks_points.append((x, y))
    # for n in range(27,36):    #nose
    #     x = landmarks.part(n).x
    #     y = landmarks.part(n).y
    #     landmarks_points.append((x, y))
